...
Desde criança, apresento um defeito de fabrico: tenho convicções e gosto de defendê-las. Além disso, sempre gostei de conversar com pessoas que tenham opiniões diferentes das minhas (desde que não comecem a espumar pela boca, claro). 
...
É claro que o respeito é uma coisa maravilhosa, e recomenda-se. Só não acho que o respeito possua o poder mágico de alterar a realidade. Por exemplo, eu posso respeitar quem acredita que a Terra é plana. Mas o meu respeito não altera a curvatura do planeta. A Terra recusa-se obstinadamente a mudar de forma só para não ferir os delicados sentimentos do meu interlocutor.
...
Seria útil que a realidade funcionasse como alguns desejam. Imagine-se, por exemplo, um jogo de futebol em que, após uma goleada, a equipa derrotada decide que as balizas não existem. Seria reconfortante, sem dúvida. Mas arruinaria o conceito de jogo.

Alguns querem que o mundo seja como um jardim-de-infância onde todos recebem uma medalha de participação para não correrem o risco traumático de estarem errados. Essa ideia pode parecer ternurenta, mas não funciona na prática.
